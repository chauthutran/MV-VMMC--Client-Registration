...
class RequestUtils {
	...
	constructor() {
		...
		this.URL_QUERY_TEIS = this.baseURL + "trackedEntityInstances.json?program=q2Ng4S8BfO0&fields=trackedEntityInstance,attributes&ouMode=DESCENDANTS&ou=LerLJqt8r7y&page=1&pageSize=4";        
        this.fullNameFilter = "&filter=LoGHwYUQZ9y";
	};

    sendGetRequestAS = async function( filter ) {
